...
// wrapped so now doesn't change between the two usages
const currentDateTime = ((now) => {
  // https://stackoverflow.com/a/17415677/5511561
...
const departureTime = ref(currentDateTime);
...
onMounted(() => initMap(stops, update, mapURL, timetableValue, departureTime));
</script>
